...
function renderResults() {
    ...
    elements.resultGrid.querySelectorAll('img, video').forEach((media) => {
        media.addEventListener('error', () => {
            ...
            if (parent && !parent.querySelector('.result-media-error-placeholder')) {
                const placeholder = document.createElement('div');
                placeholder.className = 'result-media-error-placeholder';
                placeholder.innerHTML = '<span class="error-icon">⚠️</span><span class="error-text">Preview not found</span>';
