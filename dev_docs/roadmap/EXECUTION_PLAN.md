...
1. Открыть свежий GitHub Actions run и закрыть Gate 1.1.
2. Сразу после зелёного CI выполнить Gate 1.2 в чистом окружении.
3. Затем пройти Gate 2 и один выбранный scenario из Gate 3.
4. Не начинать новые feature phases до завершения этих проверок.
